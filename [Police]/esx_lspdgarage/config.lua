...
Config.CarDraw3DText = "[E] Ouvrir Le Garage"			-- set your desired text here
...
Config.HeliDraw3DText = "[E] Ouvrir Le Garage"		-- set your desired text here
...
Config.BoatDraw3DText = "[E] Ouvrir Le Garage"		-- set your desired text here
...
Config.PoliceVehicles = {
		...
		{ model = 'police6', label = '──────   Voitures   ──────'},

		{ model = 'police6', label = '4x4 K-9 Police departement'},

 		{ model = 'police2', label = 'Dodge Chargeur'},

		{ model = 'police3', label = '4x4 Cruiser'},

        { model = 'ghispo2', label = 'Maserati - VIR'},

		{ model = 'pol718', label = 'Porsche - VIR'},
...
Config.PoliceHelicopters = {
	...
	{ model = 'maverick', label = 'Helicoptere', livery = 0, price = 0 },
        { model = 'buzzard2', label = 'Helicoptere Nuit', livery = 0, price = 0 }
...
Config.CarOutFromPolGar = "~b~Véhicule~s~ sorti avec succès du ~y~Police Garage~s~!"
...
Config.VehicleLoadText = "Attente..."			-- text on screen when vehicle model is being loaded
