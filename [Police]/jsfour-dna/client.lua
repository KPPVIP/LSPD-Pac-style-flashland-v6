...
local dna 				= {}
local weapons = {
	[-1569615261] = {name = 'WEAPON_UNARMED', hash = 2725352035, text = 'Poing'},
	[-1716189206] = {name = 'WEAPON_KNIFE', hash = 2578778090, text = 'Couteau'},
	[1737195953]  = {name = 'WEAPON_NIGHTSTICK', hash = 1737195953, text = 'Matraque'},
	[2508868239]  = {name = 'WEAPON_BAT', hash = 2508868239, text = 'Batte de Baseball'},
	...
	[2460120199]  = {name = 'WEAPON_DAGGER', hash =2460120199, text = 'Dague Antique'},
	...
	[3756226112]  = {name = 'WEAPON_SWITCHBLADE', hash =3756226112, text = 'Couteau Suisse'},
	[3441901897]  = {name = 'WEAPON_BATTLEAXE', hash =3441901897, text = 'Hache de Guerre'},
	[2484171525]  = {name = 'WEAPON_POOLCUE', hash =2484171525, text = 'Queue de Billard'},
	[419712736]   = {name = 'WEAPON_WRENCH', hash =419712736, text = 'Clé Anglaise'}
}
	...
	if dna.p == nil then
		...
		if IsPedFatallyInjured(ped) then
			...
			if weapon ~= nil then
				...
				ESX.ShowNotification('Vous venez de prendre l\'ADN d\'une cadavre...')
			else
				ESX.ShowNotification("Vous n'avez pas trouvé d'ADN...")
			end
		else
			dna = {k = nil, d = nil, w = nil, p = GetPlayerServerId(player)}
			ESX.ShowNotification('Vous venez de prendre l\'ADN d\'une personne vivante...')
		end
	else
		ESX.ShowNotification('Vous avez déjà un échantillon d\'ADN sur vous, veuillez le télécharger...')
	end
end)
