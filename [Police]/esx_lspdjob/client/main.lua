	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			...
			if job == 'bullet_wear' then
			  ...
			  ESX.ShowNotification("~r~~h~Debut~w~ de service~b~ police~w~ !")
			...
			if job == 'tenu_sahpg' then
			  ...
			  ESX.ShowNotification("~r~~h~Debut~w~ de service~b~ police~w~ !")
                        ...
                        if job == 'intendent_wear' then
                                  TriggerServerEvent("player:serviceOn", "police")
			  ESX.ShowNotification("~r~~h~Debut~w~ de service~b~ police~w~ !")

			end
                            
                        if job == 'lieutenant_wear' then
                                  TriggerServerEvent("player:serviceOn", "police")
			  ESX.ShowNotification("~r~~h~Debut~w~ de service~b~ police~w~ !")

			end

                        if job == 'recruit_wear' then
                                  TriggerServerEvent("player:serviceOn", "police")
			  ESX.ShowNotification("~r~~h~Debut~w~ de service~b~ police~w~ !")
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'citizen_wear' then
		  TriggerServerEvent("player:serviceOff", "police")
			ESX.ShowNotification("~r~~h~Fin~w~ de service~b~ police~w~ !")
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = '<span style="color:black;">💡 Status de l\'agent <span style="color:cyan;"> >', value = 'status'},
			{label = '<span style="color:black;">👥 Interaction Citoyen <span style="color:cyan;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:black;">⛓️ Menu Menottes<span style="color:cyan;"> >', value = 'menu_menottes'},
			{label = '<span style="color:black;">🚗 Interaction vehicule <span style="color:cyan;"> >', value = 'vehicle_interaction'},
			{label = '<span style="color:black;">🧊 Menu objets <span style="color:cyan;"> >', value = 'object_spawner'},
			{label = '<span style="color:black;">📜 Donner une ammende<span style="color:cyan;"> >', value = 'ammende'},
			{label = '<span style="color:black;">🛡️ Demande de renfort<span style="color:cyan;"> >', value = 'renfort'}
	}}, function(data, menu)
		...
		elseif data.current.value == 'status' then
			...
			local elements = {
				...
				{label = '<span style="color:orange;">Refus<span style="color:gray;"> d\'obtempÃ©rer / DÃ©lit de fuite', value = 'refus'},
		...
		elseif data.current.value == 'vehicle_interaction' then
			...
			--table.insert(elements, {label = 'FourriÃ¨re (Ã  cotÃ© du vÃ©hicule)', value = 'impound2'})
		...
		elseif data.current.value == 'renfort' then
			...
			table.insert(elements, {label = ('Toute les unitÃ©es demandÃ© !'), value = 'omgad'})
		...
		elseif data.current.value == 'lspd_equipement' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'lspd_equipement', {
				...
				if action == 'equipement_cadet' then
					...
					ESX.ShowAdvancedNotification('LSPD INFO', 'Armurie LSPD', 'Voila ton Ã©quipement, le perd pas.', 'CHAR_AMMUNATION', 1)
...
AddEventHandler('police:InfoService', function(service, nom)
	...
	elseif service == 'refus' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD INFORMATIONS', '~b~Refus d\'obtempÃ©rer', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-30\n~w~Information: ~g~Refus d\'obtempÃ©rer / DÃ©lit de fuite en cours.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
